...
public class TouristRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		String serviceUrl = "http://localhost:8080/SpringRest_14_ProviderAppPathVariableJSONDataExchange/wish/api/register";
		...
		ResponseEntity<String> response = template.exchange(serviceUrl, 
				...
				request,
				String.class);
				//postForEntity(serviceUrl, request, String.class);
