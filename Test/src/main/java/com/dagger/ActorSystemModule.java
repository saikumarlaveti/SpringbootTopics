...
import com.util.ClusterListenerActor;

import javax.inject.Singleton;

@Module()
public class ActorSystemModule {
    public final String SYSTEM_NAME = "${package.getClass().forName("org.apache.velocity.util.StringUtils").capitalizeFirstLetter("$artifactId").split("-", 2)[0]}Service";
    @Provides
    @Singleton
